  ...
  pursuit: {
    ...
    condition: {
      ...
      onFoeBeforeSwitchOut(pokemon) {
        ...
        if (!source.isAdjacent(pokemon) || !source.hp || source.volatiles["encore"] && source.volatiles["encore"].move !== "pursuit" || !this.queue.cancelMove(source)) {
          return;
        }
