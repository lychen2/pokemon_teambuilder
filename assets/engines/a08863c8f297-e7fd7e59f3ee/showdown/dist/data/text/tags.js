...
const TagsText = {
  ...
  restrictedlegendary: {
    ...
    desc: "Officially called Special Pok\xE9mon. Legendaries restricted from most in-game formats. Usually BST at least 660."
  },
  ultrabeast: {
    name: "Ultra Beast"
  },
  ...
  fist: {
    ...
    desc: "Boosted 1.2\xD7 by Iron Fist."
  },
  pulse: {
    name: "Pulse",
    hint: "boosted by Mega Launcher",
    desc: "Boosted 1.5\xD7 by Mega Launcher."
  },
  bite: {
    name: "Bite",
    hint: "boosted by Strong Jaw",
    desc: "Boosted 1.5\xD7 by Strong Jaw."
  },
  bullet: {
    name: "Bullet",
  ...
  slicing: {
    ...
    desc: "Boosted 1.5\xD7 by Sharpness."
  },
  wind: {
    name: "Wind",
  ...
  lgpe: {
    name: "LGPE",
    desc: "Obtainable in Pok\xE9mon: Let's Go, Pikachu! or Let's Go, Eevee!, but not in this game."
  },
  unobtainable: {
    name: "Unobtainable",
