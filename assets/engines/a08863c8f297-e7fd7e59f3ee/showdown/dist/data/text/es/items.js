...
const ItemsText = {
  abilityshield: {
    ...
    shortDesc: null,
    // NEEDS TRANSLATION
    block: "  \xA1El Escudo Habilidad ha protegido la habilidad de {POKEMON}!"
  },
  abomasite: {
    name: null,
    // NEEDS TRANSLATION
  ...
  airballoon: {
    ...
    shortDesc: null,
    // NEEDS TRANSLATION
    start: "  \xA1{POKEMON} est\xE1 flotando con un Globo Helio!",
    end: "  \xA1Ha explotado el Globo Helio de {POKEMON}!"
  },
  alakazite: {
    name: null,
    // NEEDS TRANSLATION
  ...
  blacksludge: {
    ...
    shortDesc: null,
    // NEEDS TRANSLATION
    heal: "  \xA1{POKEMON} ha recuperado unos pocos PS gracias al Lodo Negro!"
  },
  blackglasses: {
    name: "Gafas de Sol",
    grammar: "fp",
  ...
  choiceband: {
    name: "Cinta Elecci\xF3n",
    shortDesc: null
    // NEEDS TRANSLATION
  },
  choicescarf: {
    name: "Pa\xF1uelo Elecci\xF3n",
    grammar: "ms",
    shortDesc: null
    // NEEDS TRANSLATION
  },
  choicespecs: {
    name: "Gafas Elecci\xF3n",
    shortDesc: null
    // NEEDS TRANSLATION
  },
  chopleberry: {
  ...
  clearamulet: {
    ...
    shortDesc: null,
    // NEEDS TRANSLATION
    block: "  \xA1El Amuleto Puro ha impedido que disminuyan las caracter\xEDsticas de {POKEMON}!"
  },
  clefablite: {
    name: null,
    // NEEDS TRANSLATION
  ...
  custapberry: {
    ...
    shortDesc: null,
    // NEEDS TRANSLATION
    activate: "  \xA1Gracias a la Baya Chiri, {POKEMON} puede tener prioridad!"
  },
  damprock: {
    name: "Roca Lluvia",
    grammar: "fs",
  ...
  dragonmemory: {
    name: "Disco Drag\xF3n",
    shortDesc: null
    // NEEDS TRANSLATION
  },
  dragonscale: {
    name: "Escama Drag\xF3n",
    shortDesc: null,
    // NEEDS TRANSLATION
    gen2: {
      shortDesc: null
  ...
  ejectbutton: {
    name: "Bot\xF3n Escape",
    shortDesc: null,
    // NEEDS TRANSLATION
    end: "  \xA1{POKEMON} regresa gracias al Bot\xF3n Escape!"
  },
  ejectpack: {
    name: "Mochila Escape",
    shortDesc: null,
    // NEEDS TRANSLATION
    end: "  \xA1{POKEMON} regresa gracias a la Mochila Escape!"
  },
  electirizer: {
    name: "Electrizador",
    shortDesc: null
  ...
  focusband: {
    ...
    activate: "  \xA1{POKEMON} ha usado la Cinta Aguante y ha logrado resistir!"
  },
  focussash: {
    name: "Banda Aguante",
    grammar: "fs",
    ...
    end: "  \xA1{POKEMON} ha usado la Banda Aguante y ha logrado resistir!"
  },
  fossilizedbird: {
    name: "Ornitof\xF3sil",
    shortDesc: null
  ...
  leftovers: {
    ...
    shortDesc: null,
    // NEEDS TRANSLATION
    heal: "  \xA1{POKEMON} ha recuperado unos pocos PS gracias a los Restos!"
  },
  leppaberry: {
    name: "Baya Zanama",
    grammar: "fs",
    shortDesc: null,
    // NEEDS TRANSLATION
    activate: "  \xA1{POKEMON} ha recuperado los PP de {MOVE} gracias a la Baya Zanama!"
  },
  levelball: {
    name: "Nivel Ball",
    shortDesc: null
  ...
  lifeorb: {
    ...
    shortDesc: null,
    // NEEDS TRANSLATION
    damage: "  \xA1{POKEMON} ha perdido unos pocos PS!"
  },
  lightball: {
    name: "Bola Luminosa",
    grammar: "fs",
  ...
  metalcoat: {
    name: "Revest. Met\xE1lico",
    grammar: "ms",
    classified: {
      name: "Revestimiento Met\xE1lico",
      grammar: "ms"
    },
  ...
  mirrorherb: {
    ...
    shortDesc: null,
    // NEEDS TRANSLATION
    activate: "  \xA1{POKEMON} ha usado una Hierba Copia y ha copiado los cambios en las caracter\xEDsticas del rival!"
  },
  mistyseed: {
    name: "Semilla Bruma",
    shortDesc: null
  ...
  mysticwater: {
    name: "Agua M\xEDstica",
    grammar: "fu",
    articleRule: "stressed-a",
    classified: {
      name: "colgante de Agua M\xEDstica",
      grammar: "ms"
    },
    shortDesc: null,
    // NEEDS TRANSLATION
  ...
  powerherb: {
    ...
    shortDesc: null,
    // NEEDS TRANSLATION
    end: "  \xA1{POKEMON} ya est\xE1 listo gracias a la Hierba \xDAnica!"
  },
  powerlens: {
    name: "Lente Recia",
    shortDesc: null
  ...
  protectivepads: {
    ...
    shortDesc: null,
    // NEEDS TRANSLATION
    block: "  \xA1{POKEMON} ha neutralizado el efecto gracias al Paracontacto!"
  },
  protector: {
    name: "Protector",
    shortDesc: null
  ...
  quickclaw: {
    ...
    activate: "  \xA1Gracias a la Garra R\xE1pida, {POKEMON} puede tener prioridad!"
  },
  quickpowder: {
    name: "Polvo Veloz",
    shortDesc: null
  ...
  redcard: {
    ...
    shortDesc: null,
    // NEEDS TRANSLATION
    end: "  \xA1{POKEMON} le ha sacado una Tarjeta Roja a {TARGET}!"
  },
  redorb: {
    name: "Prisma Rojo",
    shortDesc: null
  ...
  rockyhelmet: {
    ...
    shortDesc: null,
    // NEEDS TRANSLATION
    damage: "  \xA1El Casco Dentado ha da\xF1ado a {POKEMON}!"
  },
  roomservice: {
    name: "Servicio Raro",
    shortDesc: null
  ...
  safetygoggles: {
    ...
    shortDesc: null,
    // NEEDS TRANSLATION
    block: "  \xA1{MOVE} no ha afectado a {POKEMON} gracias a la Gafa Protectora!"
  },
  sailfossil: {
    name: "F\xF3sil Aleta",
    shortDesc: null
  ...
  shellbell: {
    ...
    shortDesc: null,
    // NEEDS TRANSLATION
    heal: "  \xA1{POKEMON} ha recuperado unos pocos PS gracias al Cascabel Concha!"
  },
  shinystone: {
    name: "Piedra D\xEDa",
  ...
  stoneplate: {
    name: "Tabla P\xE9trea",
    shortDesc: null
    // NEEDS TRANSLATION
  },
  strangeball: {
    name: "Extra\xF1a Ball",
    shortDesc: null
    // NEEDS TRANSLATION
  },
  strawberrysweet: {
  ...
  ultranecroziumz: {
    ...
    shortDesc: null,
    // NEEDS TRANSLATION
    transform: "  \xA1{POKEMON} emite una luz cegadora!",
    activate: "\xA1{POKEMON} ha adoptado una nueva forma gracias a la Ultraexplosi\xF3n!"
  },
  unremarkableteacup: {
  ...
  whiteherb: {
    ...
    shortDesc: null,
    // NEEDS TRANSLATION
    end: "  \xA1La Hierba Blanca ha restaurado las caracter\xEDsticas de {POKEMON}!"
  },
  widelens: {
    name: "Lupa",
    grammar: "fs",
  ...
  mysteryberry: {
    ...
    shortDesc: null,
    // NEEDS TRANSLATION
    activate: "  \xA1{POKEMON} ha restaurado los PP de {MOVE} con la Baya Misterio!"
  },
  pinkbow: {
    name: null,
    // NEEDS TRANSLATION
