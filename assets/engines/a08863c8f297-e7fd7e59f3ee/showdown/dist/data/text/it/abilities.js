...
const AbilitiesText = {
  ...
  asone: {
    ...
    shortDesc: null,
    // NEEDS TRANSLATION
    start: "  {POKEMON} ha due abilit\xE0!"
  },
  asoneglastrier: {
    name: "Sintonia Equina (Glastrier)",
    // PS-style disambiguator (not part of the official name)
    shortDesc: null
    // NEEDS TRANSLATION
  },
  asonespectrier: {
    name: "Sintonia Equina (Spectrier)",
    // PS-style disambiguator (not part of the official name)
    shortDesc: null
    // NEEDS TRANSLATION
  },
  ...
  beadsofruin: {
    ...
    shortDesc: null,
    // NEEDS TRANSLATION
    start: "  La Difesa Speciale dei Pok\xE9mon intorno si indebolisce a causa dell\u2019abilit\xE0 Monile Nefasto di {POKEMON}!"
  },
  beastboost: {
    name: "Ultraboost",
  ...
  comatose: {
    ...
    shortDesc: null,
    // NEEDS TRANSLATION
    start: "  {POKEMON} \xE8 in uno stato di dormiveglia!"
  },
  commander: {
    ...
    shortDesc: null,
    // NEEDS TRANSLATION
    activate: "  {POKEMON} \xE8 stato inghiottito da {TARGET} con la funzione di Torre di Comando!"
  },
  competitive: {
    name: "Tenacia",
  ...
  damp: {
    ...
    block: "  {SOURCE} non pu\xF2 usare {MOVE}!"
  },
  dancer: {
    name: "Sincrodanza",
  ...
  darkaura: {
    ...
    shortDesc: null,
    // NEEDS TRANSLATION
    start: "  L\u2019abilit\xE0 Auratetra di {POKEMON} \xE8 attiva."
  },
  dauntlessshield: {
    name: "Scudo Saldo",
    shortDesc: null,
  ...
  disguise: {
    ...
    transform: "{POKEMON} \xE8 stato smascherato!"
  },
  download: {
    name: "Download",
  ...
  electromorphosis: {
    ...
    shortDesc: null,
    // NEEDS TRANSLATION
    start: "  {POKEMON} si carica di elettricit\xE0 grazie alla mossa {MOVE}!"
  },
  embodyaspectcornerstone: {
    name: "Albergamemorie (Fondamenta)",
    // PS-style disambiguator (not part of the official name)
    shortDesc: null,
    // NEEDS TRANSLATION
  ...
  embodyaspectteal: {
    name: "Albergamemorie (Turchese)",
    // PS-style disambiguator (not part of the official name)
    shortDesc: null,
    // NEEDS TRANSLATION
    boost: "  {POKEMON} fa brillare la Maschera Turchese, e la sua Velocit\xE0 aumenta!"
  },
  embodyaspectwellspring: {
    name: "Albergamemorie (Pozzo)",
    // PS-style disambiguator (not part of the official name)
    shortDesc: null,
    // NEEDS TRANSLATION
  ...
  fairyaura: {
    ...
    shortDesc: null,
    // NEEDS TRANSLATION
    start: "  L\u2019abilit\xE0 Aurafolletto di {POKEMON} \xE8 attiva."
  },
  filter: {
    name: "Filtro",
    shortDesc: null
  ...
  flowerveil: {
    ...
    shortDesc: null,
    // NEEDS TRANSLATION
    block: "  L\u2019abilit\xE0 Fiorvelo protegge {POKEMON}!"
  },
  fluffy: {
    name: "Morbidone",
  ...
  forewarn: {
    ...
    activate: "  La mossa {MOVE} di {TARGET} \xE8 stata scoperta!",
  ...
  hadronengine: {
    ...
    shortDesc: null,
    // NEEDS TRANSLATION
    start: "  {POKEMON} genera un Campo Elettrico e d\xE0 impulso al motore del futuro!",
    activate: "  {POKEMON} d\xE0 impulso al motore del futuro grazie al Campo Elettrico!"
  },
  harvest: {
    name: "Coglibacche",
  ...
  hospitality: {
    ...
    shortDesc: null,
    // NEEDS TRANSLATION
    heal: "  {POKEMON} beve il t\xE8 che {SOURCE} gli ha preparato!"
  },
  hugepower: {
    name: "Macroforza",
    shortDesc: null
  ...
  lightningrod: {
    ...
    activate: "  {POKEMON} attira l\u2019attacco su di s\xE9!"
  },
  limber: {
    name: "Scioltezza",
    shortDesc: null
  ...
  moldbreaker: {
    ...
    start: "  {POKEMON} ha l\u2019abilit\xE0 Rompiforma!"
  },
  moody: {
    name: "Altalena",
  ...
  mummy: {
    ...
    changeAbility: "  L\u2019abilit\xE0 di {TARGET} \xE8 diventata Mummia!"
  },
  myceliummight: {
    name: "Micoforza",
    desc: null,
  ...
  orichalcumpulse: {
    ...
    shortDesc: null,
    // NEEDS TRANSLATION
    start: "  {POKEMON} intensifica i raggi solari facendo scatenare il ritmo dell\u2019antichit\xE0!",
    activate: "  {POKEMON} si gode i raggi solari facendo scatenare il ritmo dell\u2019antichit\xE0!"
  },
  overcoat: {
    name: "Copricapo",
  ...
  perishbody: {
    ...
    shortDesc: null,
    // NEEDS TRANSLATION
    start: "  Entrambi i Pok\xE9mon andranno KO dopo 3 turni!"
  },
  pickpocket: {
    name: "Arraffalesto",
  ...
  protosynthesis: {
    ...
    end: "  L\u2019effetto della Paleoattivazione di {POKEMON} \xE8 finito!"
  },
  psychicsurge: {
    name: "Psicogenesi",
    shortDesc: null
  ...
  quarkdrive: {
    ...
    start: "  {STAT:definite:capitalize} di {POKEMON} cresce!",
    end: "  L\u2019effetto della Carica Quark di {POKEMON} \xE8 finito!"
  },
  queenlymajesty: {
    name: "Regalit\xE0",
  ...
  quickdraw: {
    ...
    shortDesc: null,
    // NEEDS TRANSLATION
    activate: "  L\u2019abilit\xE0 Colpolesto rende pi\xF9 veloce {POKEMON}!"
  },
  quickfeet: {
    name: "Piedisvelti",
  ...
  receiver: {
    ...
    changeAbility: "  L\u2019abilit\xE0 {ABILITY} di {SOURCE} \xE8 passata all\u2019alleato!"
  },
  reckless: {
    name: "Temerariet\xE0",
  ...
  schooling: {
    ...
    transformEnd: "Il banco di {POKEMON} si \xE8 disperso!"
  },
  scrappy: {
    name: "Nervisaldi",
  ...
  stickyhold: {
    ...
    block: "  Lo strumento di {POKEMON} non pu\xF2 essere rubato!"
  },
  stormdrain: {
    name: "Acquascolo",
  ...
  suctioncups: {
    ...
    shortDesc: null,
    // NEEDS TRANSLATION
    block: "  {POKEMON} \xE8 ancorato al suolo grazie alle ventose!"
  },
  superluck: {
    name: "Supersorte",
    shortDesc: null
  ...
  sweetveil: {
    ...
    shortDesc: null,
    // NEEDS TRANSLATION
    block: "  {POKEMON} resta vigile a causa dell\u2019abilit\xE0 Dolcevelo!"
  },
  swiftswim: {
    name: "Nuotovelox",
  ...
  swordofruin: {
    ...
    shortDesc: null,
    // NEEDS TRANSLATION
    start: "  La Difesa dei Pok\xE9mon intorno si indebolisce a causa dell\u2019abilit\xE0 Spada Nefasta di {POKEMON}!"
  },
  symbiosis: {
    name: "Simbiosi",
    ...
    activate: "  {POKEMON} d\xE0 {ITEM:definite} {TARGET:a}!"
  },
  synchronize: {
    name: "Sincronismo",
  ...
  tabletsofruin: {
    ...
    shortDesc: null,
    // NEEDS TRANSLATION
    start: "  L\u2019Attacco dei Pok\xE9mon intorno si indebolisce a causa dell\u2019abilit\xE0 Amuleto Nefasto di {POKEMON}!"
  },
  tangledfeet: {
    name: "Intricopiedi",
    shortDesc: null
  ...
  telepathy: {
    ...
    shortDesc: null,
    // NEEDS TRANSLATION
    block: "  {POKEMON} non pu\xF2 essere attaccato da un alleato!"
  },
  teraformzero: {
    name: "Zeroformazione",
    shortDesc: null
  ...
  vesselofruin: {
    ...
    shortDesc: null,
    // NEEDS TRANSLATION
    start: "  L\u2019Attacco Speciale dei Pok\xE9mon intorno si indebolisce a causa dell\u2019abilit\xE0 Vaso Nefasto di {POKEMON}!"
  },
  victorystar: {
    name: "Vittorstella",
    shortDesc: null
