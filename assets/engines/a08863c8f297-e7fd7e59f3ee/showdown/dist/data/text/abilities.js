...
const AbilitiesText = {
  ...
  aerilate: {
    ...
    shortDesc: "This Pokemon's Normal-type moves become Flying type and have 1.2\xD7 power.",
    gen6: {
      ...
      shortDesc: "This Pokemon's Normal-type moves become Flying type and have 1.3\xD7 power."
    }
  },
  aftermath: {
    name: "Aftermath",
  ...
  analytic: {
    ...
    shortDesc: "This Pokemon's attacks have 1.3\xD7 power if it is the last to move in a turn."
  },
  angerpoint: {
    name: "Anger Point",
  ...
  aurabreak: {
    ...
    shortDesc: "While this Pokemon is active, the Dark Aura and Fairy Aura power modifier is 0.75\xD7.",
  ...
  battlebond: {
    ...
    gen8: {
      ...
      shortDesc: "After KOing a Pokemon: becomes Ash-Greninja, Water Shuriken: 20 power, hits 3\xD7."
    },
  ...
  blaze: {
    ...
    shortDesc: "At 1/3 or less of its max HP, this Pokemon's offensive stat is 1.5\xD7 with Fire attacks.",
    gen4: {
      ...
      shortDesc: "At 1/3 or less of its max HP, this Pokemon's Fire-type attacks have 1.5\xD7 power."
    }
  },
  bulletproof: {
    name: "Bulletproof",
  ...
  darkaura: {
    ...
    shortDesc: "While this Pokemon is active, a Dark move used by any Pokemon has 1.33\xD7 power.",
  ...
  dragonize: {
    ...
    shortDesc: "This Pokemon's Normal-type moves become Dragon type and have 1.2\xD7 power."
  },
  dragonsmaw: {
    name: "Dragon's Maw",
  ...
  dryskin: {
    ...
    shortDesc: "This Pokemon is healed 1/4 by Water, 1/8 by Rain; is hurt 1.25\xD7 by Fire, 1/8 by Sun.",
    gen7: {
  ...
  fairyaura: {
    ...
    shortDesc: "While this Pokemon is active, a Fairy move used by any Pokemon has 1.33\xD7 power.",
  ...
  flareboost: {
    ...
    shortDesc: "While this Pokemon is burned, its special attacks have 1.5\xD7 power."
  },
  flashfire: {
    name: "Flash Fire",
    ...
    shortDesc: "This Pokemon's Fire attacks do 1.5\xD7 damage if hit by one Fire move; Fire immunity.",
    gen4: {
  ...
  flowergift: {
    ...
    shortDesc: "If user is Cherrim and Sun is active, it and allies' Attack and Sp. Def are 1.5\xD7.",
    gen7: {
    ...
    gen4: {
      ...
      shortDesc: "If Sun is active, Attack and Sp. Def of this Pokemon and its allies are 1.5\xD7."
    }
  },
  flowerveil: {
    name: "Flower Veil",
  ...
  fluffy: {
    ...
    shortDesc: "This Pokemon takes 1/2 damage from contact moves, 2\xD7 damage from Fire moves."
  },
  forecast: {
    name: "Forecast",
  ...
  galvanize: {
    ...
    shortDesc: "This Pokemon's Normal-type moves become Electric type and have 1.2\xD7 power."
  },
  gluttony: {
    name: "Gluttony",
  ...
  gorillatactics: {
    ...
    shortDesc: "This Pokemon's Attack is 1.5\xD7, but it can only select the first move it executes."
  },
  grasspelt: {
    name: "Grass Pelt",
  ...
  guts: {
    ...
    shortDesc: "If this Pokemon is statused, its Attack is 1.5\xD7; ignores burn halving physical damage."
  },
  hadronengine: {
    name: "Hadron Engine",
    shortDesc: "On switch-in, summons Electric Terrain. During Electric Terrain, Sp. Atk is 1.3333\xD7.",
  ...
  hustle: {
    ...
    shortDesc: "This Pokemon's Attack is 1.5\xD7 and accuracy of its physical attacks is 0.8\xD7."
  },
  hydration: {
    name: "Hydration",
  ...
  ironfist: {
    ...
    shortDesc: "This Pokemon's punch-based attacks have 1.2\xD7 power. Sucker Punch is not boosted."
  },
  justified: {
    name: "Justified",
  ...
  megalauncher: {
    ...
    shortDesc: "This Pokemon's pulse moves have 1.5\xD7 power. Heal Pulse heals 3/4 target's max HP."
  },
  megasol: {
    name: "Mega Sol",
  ...
  minus: {
    ...
    shortDesc: "If an active ally has this Ability or the Plus Ability, this Pokemon's Sp. Atk is 1.5\xD7.",
    gen4: {
      desc: "If an active ally has the Plus Ability, this Pokemon's Special Attack is multiplied by 1.5.",
      shortDesc: "If an active ally has the Plus Ability, this Pokemon's Sp. Atk is 1.5\xD7."
    },
    gen3: {
      desc: "If an active Pokemon has the Plus Ability, this Pokemon's Special Attack is multiplied by 1.5.",
      shortDesc: "If an active Pokemon has the Plus Ability, this Pokemon's Sp. Atk is 1.5\xD7."
    }
  },
  mirrorarmor: {
    name: "Mirror Armor",
  ...
  neuroforce: {
    ...
    shortDesc: "This Pokemon's attacks that are super effective against the target do 1.25\xD7 damage."
  },
  neutralizinggas: {
  ...
  normalize: {
    ...
    shortDesc: "This Pokemon's moves are changed to be Normal type and have 1.2\xD7 power.",
    gen6: {
  ...
  orichalcumpulse: {
    ...
    shortDesc: "On switch-in, summons Sun. During Sun, Attack is 1.3333\xD7.",
  ...
  overgrow: {
    ...
    shortDesc: "At 1/3 or less of its max HP, this Pokemon's offensive stat is 1.5\xD7 with Grass attacks.",
    gen4: {
      ...
      shortDesc: "At 1/3 or less of its max HP, this Pokemon's Grass-type attacks have 1.5\xD7 power."
    }
  },
  owntempo: {
    name: "Own Tempo",
  ...
  pixilate: {
    ...
    shortDesc: "This Pokemon's Normal-type moves become Fairy type and have 1.2\xD7 power.",
    gen6: {
      ...
      shortDesc: "This Pokemon's Normal-type moves become Fairy type and have 1.3\xD7 power."
    }
  },
  plus: {
    name: "Plus",
    desc: "If an active ally has this Ability or the Minus Ability, this Pokemon's Special Attack is multiplied by 1.5.",
    shortDesc: "If an active ally has this Ability or the Minus Ability, this Pokemon's Sp. Atk is 1.5\xD7.",
    gen4: {
      desc: "If an active ally has the Minus Ability, this Pokemon's Special Attack is multiplied by 1.5.",
      shortDesc: "If an active ally has the Minus Ability, this Pokemon's Sp. Atk is 1.5\xD7."
    },
    gen3: {
      desc: "If an active Pokemon has the Minus Ability, this Pokemon's Special Attack is multiplied by 1.5.",
      shortDesc: "If an active Pokemon has the Minus Ability, this Pokemon's Sp. Atk is 1.5\xD7."
    }
  },
  poisonheal: {
    name: "Poison Heal",
  ...
  protosynthesis: {
    ...
    shortDesc: "Sun active or Booster Energy used: highest stat is 1.3\xD7, or 1.5\xD7 if Speed.",
  ...
  punkrock: {
    ...
    shortDesc: "This Pokemon receives 1/2 damage from sound moves. Its own have 1.3\xD7 power."
  },
  purepower: {
    name: "Pure Power",
    shortDesc: "This Pokemon's Attack is doubled."
  ...
  quarkdrive: {
    ...
    shortDesc: "Electric Terrain active or Booster Energy used: highest stat is 1.3\xD7, or 1.5\xD7 if Speed.",
  ...
  quickfeet: {
    ...
    shortDesc: "If this Pokemon is statused, its Speed is 1.5\xD7; ignores Speed drop from paralysis.",
    gen6: {
  ...
  reckless: {
    ...
    shortDesc: "This Pokemon's attacks with recoil or crash damage have 1.2\xD7 power; not Struggle."
  },
  refrigerate: {
    name: "Refrigerate",
    ...
    shortDesc: "This Pokemon's Normal-type moves become Ice type and have 1.2\xD7 power.",
    gen6: {
      ...
      shortDesc: "This Pokemon's Normal-type moves become Ice type and have 1.3\xD7 power."
    }
  },
  regenerator: {
    name: "Regenerator",
  ...
  rivalry: {
    ...
    shortDesc: "This Pokemon's attacks do 1.25\xD7 on same gender targets; 0.75\xD7 on opposite gender."
  },
  rkssystem: {
    name: "RKS System",
  ...
  sandforce: {
    ...
    shortDesc: "This Pokemon's Ground/Rock/Steel attacks do 1.3\xD7 in Sandstorm; immunity to it."
  },
  sandrush: {
    name: "Sand Rush",
  ...
  sandveil: {
    ...
    shortDesc: "If Sandstorm is active, this Pokemon's evasiveness is 1.25\xD7; immunity to Sandstorm."
  },
  sapsipper: {
    name: "Sap Sipper",
  ...
  sheerforce: {
    ...
    shortDesc: "This Pokemon's attacks with secondary effects have 1.3\xD7 power; nullifies the effects.",
    gen8: {
  ...
  snowcloak: {
    ...
    shortDesc: "If Snow is active, this Pokemon's evasiveness is 1.25\xD7.",
    gen8: {
      ...
      shortDesc: "If Hail is active, this Pokemon's evasiveness is 1.25\xD7; immunity to Hail."
    }
  },
  snowwarning: {
    name: "Snow Warning",
  ...
  solarpower: {
    ...
    shortDesc: "If Sun is active, this Pokemon's Sp. Atk is 1.5\xD7; loses 1/8 max HP per turn.",
    gen7: {
  ...
  strongjaw: {
    ...
    shortDesc: "This Pokemon's bite-based attacks have 1.5\xD7 power. Bug Bite is not boosted."
  },
  sturdy: {
    name: "Sturdy",
  ...
  supremeoverlord: {
    ...
    desc: "This Pokemon's moves have their power multiplied by 1+(X \xD7 0.1), where X is the total number of times any Pokemon has fainted on the user's side when this Ability became active, and X cannot be greater than 5.",
  ...
  swarm: {
    ...
    shortDesc: "At 1/3 or less of its max HP, this Pokemon's offensive stat is 1.5\xD7 with Bug attacks.",
    gen4: {
      ...
      shortDesc: "At 1/3 or less of its max HP, this Pokemon's Bug-type attacks have 1.5\xD7 power."
    }
  },
  sweetveil: {
    name: "Sweet Veil",
  ...
  technician: {
    ...
    shortDesc: "This Pokemon's moves of 60 power or less have 1.5\xD7 power, including Struggle.",
    gen4: {
      ...
      shortDesc: "This Pokemon's moves of 60 power or less have 1.5\xD7 power, except Struggle."
    }
  },
  telepathy: {
    name: "Telepathy",
  ...
  terashell: {
    ...
    shortDesc: "Terapagos: If full HP, attacks taken have 0.5\xD7 effectiveness unless naturally immune.",
  ...
  torrent: {
    ...
    shortDesc: "At 1/3 or less of its max HP, this Pokemon's offensive stat is 1.5\xD7 with Water attacks.",
    gen4: {
      ...
      shortDesc: "At 1/3 or less of its max HP, this Pokemon's Water-type attacks have 1.5\xD7 power."
    }
  },
  toughclaws: {
    name: "Tough Claws",
  ...
  toxicboost: {
    ...
    shortDesc: "While this Pokemon is poisoned, its physical attacks have 1.5\xD7 power."
  },
  toxicchain: {
    name: "Toxic Chain",
  ...
  waterbubble: {
    ...
    shortDesc: "This Pokemon's Water power is 2\xD7; it can't be burned; Fire power against it is halved."
  },
  watercompaction: {
