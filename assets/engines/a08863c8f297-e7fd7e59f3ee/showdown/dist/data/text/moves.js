...
const MovesText = {
  ...
  absorb: {
    name: "Absorb",
    desc: "The user recovers 1/2 the HP lost by the target, rounded half up. If Big Root is held by the user, the HP recovered is 1.3\xD7 normal, rounded half down.",
    shortDesc: "User recovers 50% of the damage dealt.",
    gen4: {
      desc: "The user recovers 1/2 the HP lost by the target, rounded down. If Big Root is held by the user, the HP recovered is 1.3\xD7 normal, rounded down."
    },
    gen3: {
  ...
  aquaring: {
    name: "Aqua Ring",
    desc: "The user has 1/16 of its maximum HP, rounded down, restored at the end of each turn while it remains active. If Big Root is held by the user, the HP recovered is 1.3\xD7 normal, rounded half down. If the user uses Baton Pass, the replacement will receive the healing effect.",
  ...
  auroraveil: {
    name: "Aurora Veil",
    desc: "For 5 turns, the user and its party members take 0.5\xD7 damage from physical and special attacks, or 0.66\xD7 damage if in a Double Battle; does not reduce damage further with Reflect or Light Screen. Critical hits ignore this protection. It is removed from the user's side if the user or an ally is successfully hit by Brick Break, Psychic Fangs, or Defog. Brick Break and Psychic Fangs remove the effect before damage is calculated. Lasts for 8 turns if the user is holding Light Clay. Fails unless the weather is Snow.",
    shortDesc: "For 5 turns, damage to allies halved. Snow only.",
    gen8: {
      desc: "For 5 turns, the user and its party members take 0.5\xD7 damage from physical and special attacks, or 0.66\xD7 damage if in a Double Battle; does not reduce damage further with Reflect or Light Screen. Critical hits ignore this protection. It is removed from the user's side if the user or an ally is successfully hit by Brick Break, Psychic Fangs, or Defog. Brick Break and Psychic Fangs remove the effect before damage is calculated. Lasts for 8 turns if the user is holding Light Clay. Fails unless the weather is Hail.",
  ...
  barbbarrage: {
    ...
    shortDesc: "50% psn. 2\xD7 power if target already poisoned."
  },
  barrage: {
    name: "Barrage",
    desc: "Hits two to five times. Has a 35% chance to hit two or three times and a 15% chance to hit four or five times. If one of the hits breaks the target's substitute, it will take damage for the remaining hits. If the user has the Skill Link Ability, this move will always hit five times.",
  ...
  charge: {
    ...
    shortDesc: "+1 SpD, user's next Electric move 2\xD7 power.",
    gen8: {
      ...
      shortDesc: "+1 SpD, user's Electric move next turn 2\xD7 power."
    },
    gen3: {
      desc: "If the user uses an Electric-type attack on the next turn, its power will be doubled.",
      shortDesc: "The user's Electric attack next turn has 2\xD7 power."
    },
  ...
  collisioncourse: {
    ...
    shortDesc: "Deals 1.3333\xD7 damage with supereffective hits."
  },
  combattorque: {
    name: "Combat Torque",
    desc: "Has a 30% chance to paralyze the target.",
  ...
  comeuppance: {
    ...
    shortDesc: "If hit by an attack, returns 1.5\xD7 damage."
  },
  confide: {
    name: "Confide",
  ...
  counter: {
    ...
    gen1: {
      ...
      shortDesc: "If hit by Normal/Fighting move, deals 2\xD7 damage."
    }
  },
  courtchange: {
    name: "Court Change",
  ...
  crushgrip: {
    name: "Crush Grip",
    desc: "Power is equal to 120 \xD7 (target's current HP / target's maximum HP), rounded half down, but not less than 1.",
    shortDesc: "More power the more HP the target has left.",
    gen4: {
      desc: "Power is equal to 120 \xD7 (target's current HP / target's maximum HP) + 1, rounded down."
    }
  },
  curse: {
    name: "Curse",
  ...
  dragonenergy: {
    name: "Dragon Energy",
    desc: "Power is equal to (user's current HP \xD7 150 / user's maximum HP), rounded down, but not less than 1.",
  ...
  drainingkiss: {
    name: "Draining Kiss",
    desc: "The user recovers 3/4 the HP lost by the target, rounded half up. If Big Root is held by the user, the HP recovered is 1.3\xD7 normal, rounded half down.",
  ...
  dreameater: {
    name: "Dream Eater",
    desc: "The target is unaffected by this move unless it is asleep. The user recovers 1/2 the HP lost by the target, rounded half up. If Big Root is held by the user, the HP recovered is 1.3\xD7 normal, rounded half down.",
    shortDesc: "User gains 1/2 HP inflicted. Sleeping target only.",
    gen4: {
      desc: "The target is unaffected by this move unless it is asleep and does not have a substitute. The user recovers 1/2 the HP lost by the target, rounded down, but not less than 1 HP. If Big Root is held by the user, the HP recovered is 1.3\xD7 normal, rounded down."
    },
    gen3: {
  ...
  expandingforce: {
    ...
    shortDesc: "User on Psychic Terrain: 1.5\xD7 power, hits foes."
  },
  explosion: {
    name: "Explosion",
  ...
  fissure: {
    ...
    gen2: {
      desc: "Deals 65535 damage to the target. This attack's accuracy out of 256 is equal to the lesser of (2 \xD7 (user's level - target's level) + 76) and 255, before applying accuracy and evasiveness modifiers. Fails if the target is at a higher level. Can hit a target using Dig."
    },
    gen1: {
  ...
  flail: {
    name: "Flail",
    desc: "The power of this move is 20 if X is 33 to 48, 40 if X is 17 to 32, 80 if X is 10 to 16, 100 if X is 5 to 9, 150 if X is 2 to 4, and 200 if X is 0 or 1, where X is equal to (user's current HP \xD7 48 / user's maximum HP), rounded down.",
    shortDesc: "More power the less HP the user has left.",
    gen4: {
      desc: "The power of this move is 20 if X is 43 to 48, 40 if X is 22 to 42, 80 if X is 13 to 21, 100 if X is 6 to 12, 150 if X is 2 to 5, and 200 if X is 0 or 1, where X is equal to (user's current HP \xD7 64 / user's maximum HP), rounded down."
    },
    gen3: {
      desc: "The power of this move is 20 if X is 33 to 48, 40 if X is 17 to 32, 80 if X is 10 to 16, 100 if X is 5 to 9, 150 if X is 2 to 4, and 200 if X is 0 or 1, where X is equal to (user's current HP \xD7 48 / user's maximum HP), rounded down."
    },
    gen2: {
      desc: "The power of this move is 20 if X is 33 to 48, 40 if X is 17 to 32, 80 if X is 10 to 16, 100 if X is 5 to 9, 150 if X is 2 to 4, and 200 if X is 0 or 1, where X is equal to (user's current HP \xD7 48 / user's maximum HP), rounded down. This move does not apply damage variance and cannot be a critical hit."
    }
  },
  flameburst: {
    name: "Flame Burst",
  ...
  frustration: {
    name: "Frustration",
    desc: "Power is equal to the greater of ((255 - user's Happiness) \xD7 2/5), rounded down, or 1.",
  ...
  glaiverush: {
    ...
    shortDesc: "User takes sure-hit 2\xD7 damage until its next turn."
  },
  glare: {
    name: "Glare",
  ...
  gmaxsteelsurge: {
    ...
    desc: "Power is equal to the base move's Max Move power. If this move is successful, it sets up a hazard on the opposing side of the field, damaging each opposing Pokemon that switches in. Foes lose 1/32, 1/16, 1/8, 1/4, or 1/2 of their maximum HP, rounded down, based on their weakness to the Steel type; 0.25\xD7, 0.5\xD7, neutral, 2\xD7, or 4\xD7, respectively. Can be removed from the opposing side if any opposing Pokemon uses Rapid Spin or Defog successfully, or is hit by Defog.",
  ...
  gmaxstonesurge: {
    ...
    desc: "Power is equal to the base move's Max Move power. If this move is successful, it sets up a hazard on the opposing side of the field, damaging each opposing Pokemon that switches in. Foes lose 1/32, 1/16, 1/8, 1/4, or 1/2 of their maximum HP, rounded down, based on their weakness to the Rock type; 0.25\xD7, 0.5\xD7, neutral, 2\xD7, or 4\xD7, respectively. Can be removed from the opposing side if any opposing Pokemon uses Rapid Spin or Defog successfully, or is hit by Defog.",
  ...
  gravapple: {
    ...
    shortDesc: "Target: 100% -1 Def. During Gravity: 1.5\xD7 power."
  },
  gravity: {
    name: "Gravity",
    ...
    shortDesc: "5 turns: no Ground immunities, 1.67\xD7 accuracy.",
    gen7: {
  ...
  guillotine: {
    ...
    shortDesc: "OHKOs the target. Fails if user is a lower level.",
    gen2: {
      desc: "Deals 65535 damage to the target. This attack's accuracy out of 256 is equal to the lesser of (2 \xD7 (user's level - target's level) + 76) and 255, before applying accuracy and evasiveness modifiers. Fails if the target is at a higher level."
    },
    gen1: {
      desc: "Deals 65535 damage to the target. Fails if the target's Speed is greater than the user's.",
      shortDesc: "Deals 65535 damage. Fails if target is faster."
  ...
  hardpress: {
    name: "Hard Press",
    desc: "Power is equal to 100 \xD7 (target's current HP / target's maximum HP), rounded half down, but not less than 1.",
    shortDesc: "More power the more HP the target has left."
  },
  haze: {
    name: "Haze",
    ...
    // Only used in Gen 1
    activate: "  All stat changes were eliminated!"
    // gen 1: "All STATUS changes are eliminated!"
  },
  headbutt: {
    name: "Headbutt",
    desc: "Has a 30% chance to make the target flinch.",
  ...
  helpinghand: {
    ...
    shortDesc: "One adjacent ally's move power is 1.5\xD7 this turn.",
  ...
  hydrosteam: {
    ...
    shortDesc: "During Sun: 1.5\xD7 damage instead of half."
  },
  hydrovortex: {
    name: "Hydro Vortex",
    shortDesc: "Power is equal to the base move's Z-Power."
  ...
  infernalparade: {
    ...
    shortDesc: "30% burn. 2\xD7 power if target is already statused."
  },
  inferno: {
    name: "Inferno",
  ...
  knockoff: {
    ...
    shortDesc: "1.5\xD7 damage if foe holds an item. Removes item.",
    champions: {
  ...
  lashout: {
    ...
    shortDesc: "2\xD7 power if the user had a stat lowered this turn."
  },
  lastresort: {
    name: "Last Resort",
  ...
  lastrespects: {
    name: "Last Respects",
    desc: "Power is equal to 50+(X \xD7 50), where X is the total number of times any Pokemon has fainted on the user's side, and X cannot be greater than 100.",
  ...
  leechseed: {
    name: "Leech Seed",
    desc: "The Pokemon at the user's position steals 1/8 of the target's maximum HP, rounded down, at the end of each turn. If Big Root is held by the recipient, the HP recovered is 1.3\xD7 normal, rounded half down. If the target uses Baton Pass, the replacement will continue being leeched. If the target switches out or uses Mortal Spin or Rapid Spin successfully, the effect ends. Grass-type Pokemon are immune to this move on use, but not its effect.",
  ...
  lightscreen: {
    name: "Light Screen",
    desc: "For 5 turns, the user and its party members take 0.5\xD7 damage from special attacks, or 0.66\xD7 damage if in a Double Battle. Damage is not reduced further with Aurora Veil. Critical hits ignore this effect. It is removed from the user's side if the user or an ally is successfully hit by Brick Break, Psychic Fangs, or Defog. Lasts for 8 turns if the user is holding Light Clay. Fails if the effect is already active on the user's side.",
    shortDesc: "For 5 turns, special damage to allies is halved.",
    gen6: {
      desc: "For 5 turns, the user and its party members take 0.5\xD7 damage from special attacks, or 0.66\xD7 damage if in a Double or Triple Battle. Critical hits ignore this effect. It is removed from the user's side if the user or an ally is successfully hit by Brick Break or Defog. Lasts for 8 turns if the user is holding Light Clay. Fails if the effect is already active on the user's side."
    },
    gen4: {
    ...
    gen1: {
      ...
      shortDesc: "While active, user's Special is 2\xD7 when damaged.",
  ...
  magnitude: {
    ...
    shortDesc: "Hits adjacent Pokemon. Power varies; 2\xD7 on Dig.",
    gen4: {
  ...
  matchagotcha: {
    name: "Matcha Gotcha",
    desc: "Has a 20% chance to burn the target. The user recovers 1/2 the HP lost by the target, rounded half up. If Big Root is held by the user, the HP recovered is 1.3\xD7 normal, rounded half down. The target thaws out if it is frozen.",
  ...
  mefirst: {
    ...
    shortDesc: "Copies a foe at 1.5\xD7 power. User must be faster.",
    gen8: {
  ...
  mistyexplosion: {
    ...
    shortDesc: "User faints. User on Misty Terrain: 1.5\xD7 power."
  },
  mistyterrain: {
    name: "Misty Terrain",
  ...
  pikapapow: {
    name: "Pika Papow",
    desc: "Power is equal to the greater of (user's Happiness \xD7 2/5), rounded down, or 1.",
  ...
  powertrip: {
    name: "Power Trip",
    desc: "Power is equal to 20+(X \xD7 20), where X is the user's total stat stage changes that are greater than 0.",
  ...
  psyblade: {
    ...
    shortDesc: "During Electric Terrain: 1.5\xD7 power."
  },
  psychic: {
    name: "Psychic",
    desc: "Has a 10% chance to lower the target's Special Defense by 1 stage.",
  ...
  psywave: {
    name: "Psywave",
    desc: "Deals damage to the target equal to (user's level) \xD7 (X + 50) / 100, where X is a random number from 0 to 100, rounded down, but not less than 1 HP.",
    shortDesc: "Random damage equal to 0.5\xD7-1.5\xD7 user's level.",
    gen4: {
      desc: "Deals damage to the target equal to (user's level) \xD7 (X \xD7 10 + 50) / 100, where X is a random number from 0 to 10, rounded down, but not less than 1 HP."
    },
    gen2: {
      desc: "Deals damage to the target equal to a random number from 1 to (user's level \xD7 1.5 - 1), rounded down, but not less than 1 HP.",
      shortDesc: "Random damage from 1 to (user's level \xD7 1.5 - 1)."
    }
  },
  pulverizingpancake: {
  ...
  punishment: {
    name: "Punishment",
    desc: "Power is equal to 60+(X \xD7 20), where X is the target's total stat stage changes that are greater than 0, but not more than 200 power.",
  ...
  pursuit: {
    ...
    shortDesc: "If a foe is switching out, hits it at 2\xD7 power.",
    gen7: {
  ...
  ragefist: {
    name: "Rage Fist",
    desc: "Power is equal to 50+(X \xD7 50), where X is the total number of times the user has been hit by a damaging attack during the battle, even if the user did not lose HP from the attack. X cannot be greater than 6 and does not reset upon switching out or fainting. Each hit of a multi-hit attack is counted, but confusion damage is not counted.",
    shortDesc: "+50 power for each time user was hit. Max 6 hits.",
    champions: {
      desc: "Power is equal to 50+(X \xD7 50), where X is the total number of times the user has been hit by a damaging attack during the battle, even if the user did not lose HP from the attack. X cannot be greater than 6 and resets to 0 when the user leaves the field. Each hit of a multi-hit attack is counted, but confusion damage is not counted.",
  ...
  reflect: {
    name: "Reflect",
    desc: "For 5 turns, the user and its party members take 0.5\xD7 damage from physical attacks, or 0.66\xD7 damage if in a Double Battle. Damage is not reduced further with Aurora Veil. Critical hits ignore this effect. It is removed from the user's side if the user or an ally is successfully hit by Brick Break, Psychic Fangs, or Defog. Lasts for 8 turns if the user is holding Light Clay. Fails if the effect is already active on the user's side.",
    shortDesc: "For 5 turns, physical damage to allies is halved.",
    gen6: {
      desc: "For 5 turns, the user and its party members take 0.5\xD7 damage from physical attacks, or 0.66\xD7 damage if in a Double or Triple Battle. Critical hits ignore this effect. It is removed from the user's side if the user or an ally is successfully hit by Brick Break or Defog. Lasts for 8 turns if the user is holding Light Clay. Fails if the effect is already active on the user's side."
    },
    gen4: {
  ...
  risingvoltage: {
    ...
    shortDesc: "2\xD7 power if target is grounded in Electric Terrain."
  },
  roar: {
    name: "Roar",
    ...
    shortDesc: "Forces the target to switch to a random ally.",
    gen4: {
      desc: "The target is forced to switch out and be replaced with a random unfainted ally. Fails if the target is the last unfainted Pokemon in its party, if the target used Ingrain previously or has the Suction Cups Ability, or if the user's level is lower than the target's and X \xD7 (user's level + target's level) / 256 + 1 is less than or equal to (target's level / 4), rounded down, where X is a random number from 0 to 255."
    },
    gen2: {
  ...
  sandstorm: {
    ...
    shortDesc: "For 5 turns, a sandstorm rages. Rock: 1.5\xD7 SpD.",
    gen4: {
  ...
  snowscape: {
    ...
    shortDesc: "For 5 turns, snow falls. Ice: 1.5\xD7 Def."
  },
  soak: {
    name: "Soak",
  ...
  stealthrock: {
    name: "Stealth Rock",
    desc: "Sets up a hazard on the opposing side of the field, damaging each opposing Pokemon that switches in. Fails if the effect is already active on the opposing side. Foes lose 1/32, 1/16, 1/8, 1/4, or 1/2 of their maximum HP, rounded down, based on their weakness to the Rock type; 0.25\xD7, 0.5\xD7, neutral, 2\xD7, or 4\xD7, respectively. Can be removed from the opposing side if any Pokemon uses Tidy Up, or if any opposing Pokemon uses Mortal Spin, Rapid Spin, or Defog successfully, or is hit by Defog.",
  ...
  strengthsap: {
    name: "Strength Sap",
    desc: "Lowers the target's Attack by 1 stage. The user restores its HP equal to the target's Attack stat calculated with its stat stage before this move was used. If Big Root is held by the user, the HP recovered is 1.3\xD7 normal, rounded half down. Fails if the target's Attack stat stage is -6.",
