...
class RandomDelta extends import_teams.RandomTeams {
  constructor() {
    super(...arguments);
  ...
  getItem(ability, types, moves, counter, teamDetails, species, isLead, teraType, role) {
    ...
    if ((species.id === "thrashmachine" || species.id === "thrashmachineduck" || species.id === "thrashmachineflame" || species.id === "thrashmachinelaser") && role === "Choice Item user") return this.sample(["Choice Scarf", "Choice Band"]);
    ...
    if (species.id === "aaron" && role === "Wallbreaker" || species.id === "astigmatism" && role === "Choice Item user" || species.id === "cowboymike" && role === "Choice Item user" || species.id === "dogamy" && role === "Choice Item user" || species.id === "dogaressa" && role === "Choice Item user" || species.id === "flowery" && role === "Choice Item user" || species.id === "glyde" && role === "Choice Item user" || species.id === "icecap" && role === "Wallbreaker" || species.id === "icewolf" && role === "Bulky Attacker" || species.id === "kround" && role === "Choice Item user" || species.id === "lancer" && role === "Choice Item user" || species.id === "lemonbread" && role === "Choice Item user" || species.id === "mauswheel" && role === "Choice Item user" || species.id === "papyrus" && role === "Choice Item user" || species.id === "shinobeetle" && role === "Choice Item user" || species.id === "tsunderplane" && role === "Choice Item user" || species.id === "werewerewire" && role === "Choice Item user") return "Choice Band";
    if (species.id === "abberant" && role === "AV Pivot" || species.id === "alphys" && role === "Wallbreaker" || species.id === "ambyulance" && role === "AV Pivot" || species.id === "missmizzle" && role === "AV Pivot" || species.id === "royalguard1" && role === "AV Pivot") return "Assault Vest";
    if (species.id === "abberant" && role === "Bulky Support" || species.id === "winglade" && role === "Bulky Support") return "Rocky Helmet";
    if (species.id === "aqua" && role === "Setup Sweeper" || species.id === "kris" && role === "Setup Sweeper" || species.id === "lesserdog" && role === "Setup Sweeper" || species.id === "mrsociety" && role === "Wallbreaker" || species.id === "parsnik" && role === "Wallbreaker" || species.id === "pipis" && role === "Bulky Attacker" || species.id === "sheary" && role === "Wallbreaker" || species.id === "shyren" && role === "Wallbreaker" || species.id === "tasquemanager" && role === "Setup Sweeper" || species.id === "tenna" && role === "Wallbreaker" || species.id === "thrashmachineduck" && role === "Fast Attacker" || species.id === "whitecloak" && role === "Wallbreaker") return "Life Orb";
    if (species.id === "aqua" && role === "Z-Move user") return "Cyan Omega Petal";
    if (species.id === "asriel" && role === "Wallbreaker" || species.id === "balthizard" && role === "Bulky Support" || species.id === "crystal" && role === "Fast Support" || species.id === "hacker" && role === "Fast Support" || species.id === "migospel" && role === "Fast Support" || species.id === "netskie" && role === "Fast Attacker" || species.id === "onionsan" && role === "Bulky Support" || species.id === "sans" && role === "Wallbreaker" || species.id === "shadowmantle" && role === "Wallbreaker" || species.id === "snowdrake" && role === "Bulky Support" || species.id === "swatch" && role === "Bulky Support" || species.id === "sweet" && role === "Fast Support" || species.id === "toriel" && role === "Bulky Attacker") return "Heavy-Duty Boots";
    ...
    if (species.id === "bloxer" && role === "Bulky Attacker" || species.id === "endogeny" && role === "Bulky Support" || species.id === "finalfroggit" && role === "Fast Support" || species.id === "flowey" && role === "Fast Support" || species.id === "gerson" && role === "Bulky Support" || species.id === "green" && role === "Bulky Support" || species.id === "jackenstein" || species.id === "jevil" && role === "Fast Support" || species.id === "kawkaw" && role === "Bulky Support" || species.id === "kk" && role === "Bulky Support" || species.id === "knightknight" && role === "Bulky Setup" || species.id === "kround" && role === "Bulky Setup" || species.id === "pipis" && role === "Staller" || species.id === "ralsei" && role === "Bulky Support" || species.id === "ralsei" && role === "Bulky Setup" || species.id === "ramb" && role === "Fast Support" || species.id === "ribbick" && role === "Bulky Support" || species.id === "royalguard1" && role === "Bulky Support" || species.id === "rudinnranger" && role === "Bulky Support" || species.id === "seam" && role === "Bulky Support" || species.id === "seam" && role === "Bulky Setup" || species.id === "temmie" && role === "Fast Support" || species.id === "terakota" && role === "Bulky Support" || species.id === "titan" && role === "Bulky Attacker" || species.id === "titanspawn" && role === "Bulky Support" || species.id === "topchef" && role === "Fast Attacker" || species.id === "undyne" && role === "Bulky Setup" || species.id === "winglade" && role === "Bulky Setup") return "Leftovers";
    if (species.id === "blue" && role === "Z-Move user") return "Azure Omega Petal";
    if (species.id === "capn" && role === "Wallbreaker" || species.id === "carol" && role === "Choice Item user" || species.id === "chilldrake" && role === "Choice Item user" || species.id === "elnina" && role === "Choice Item user" || species.id === "kawkaw" && role === "Choice Item user" || species.id === "leafling" && role === "Choice Item user" || species.id === "mrsunshine" && role === "Choice Item user" || species.id === "vulkin" && role === "Choice Item user" || species.id === "watercooler" && role === "Choice Item user") return "Choice Specs";
    if (species.id === "catmike" && role === "Fast Attacker" || species.id === "clover" && role === "Setup Sweeper" || species.id === "motormouthmike" && role === "Setup Sweeper") return "Loaded Dice";
    ...
    if (species.id === "flowery" && role === "Setup Sweeper" || species.id === "mrsunshine" && role === "Wallbreaker") return "Booster Energy";
    ...
    if (species.id === "green" && role === "Fast Support" || species.id === "noelle" && role === "Fast Support" || species.id === "poppup" && role === "Bulky Support") return "Light Clay";
    if (species.id === "gyftrot" && role === "Setup Sweeper" || species.id === "leafling" && role === "Setup Sweeper" || species.id === "zapper" && role === "Bulky Setup") return "Sitrus Berry";
    if (species.id === "kris" && role === "Wallbreaker" || species.id === "memoryhead" && role === "Fast Attacker" || species.id === "mrelegance" && role === "Choice Item user" || species.id === "napstablook" && role === "Choice Item user" || species.id === "netskie" && role === "Wallbreaker" || species.id === "organikk" && role === "Choice Item user" || species.id === "pippins" && role === "Fast Attacker" || species.id === "shadowguy" && role === "Choice Item user" || species.id === "shuttah" && role === "Choice Item user" || species.id === "starwalker" && role === "Choice Item user" || species.id === "swatch" && role === "Choice Item user") return "Choice Scarf";
    if (species.id === "lancer" && role === "Fast Support" || species.id === "muffet" && role === "Fast Support") return "Focus Sash";
    ...
    if (species.id === "queendelta" && role === "Fast Attacker" || species.id === "rabbick" && role === "Bulky Support" || species.id === "trashy" && role === "Bulky Support") return "Black Sludge";
