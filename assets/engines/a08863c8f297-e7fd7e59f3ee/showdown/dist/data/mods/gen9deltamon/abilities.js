...
const Abilities = {
  ...
  swordplay: {
    ...
    onModifyDamage(damage, source, target, move) {
      if (move.pierce && move.flags?.slicing && target.volatiles["protect"]) {
  ...
  reverberate: {
    ...
    onPrepareHit(source, target, move) {
      if (move.category === "Status" || move.multihit || move.flags["noparentalbond"] || move.flags["charge"] || move.flags["futuremove"] || move.spreadHit || move.isZ || move.isMax || !move.flags["sound"]) return;
      move.multihit = 2;
