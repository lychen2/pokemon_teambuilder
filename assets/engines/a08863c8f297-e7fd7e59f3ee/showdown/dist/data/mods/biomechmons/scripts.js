...
const Scripts = {
  pokemon: {
    ...
    eatItem(force, source, sourceEffect) {
      ...
      if (this.battle.runEvent("UseItem", this, null, null, this.battle.dex.items.get(item.name)) && (force || this.battle.runEvent("TryEatItem", this, null, null, this.battle.dex.items.get(item.name)))) {
