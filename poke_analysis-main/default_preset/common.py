...
PASTE_SETS_PATH = STATIC_DIR / "paste_sets_champions_mb.json"
PASTE_TEAMS_PATH = STATIC_DIR / "paste_teams_champions_mb.json"
VGCPASTES_CSV_PATH = STATIC_DIR / "VGCPastes Repository - Champions M-B.csv"
VGCPASTES_FALLBACK_CSV_PATH = STATIC_DIR / "VGCPastes Repository - Champions M-A.csv"
